...
void main() {
  group('IgdbConstants.resolveCategory Tests', () {
    test(
      'Resuelve categorías numéricas de IGDB que no son juego base ( != 0 )',
      () {
    ...
    test(
      'Detecta Remakes por palabras clave en el título cuando category es 0 o null',
      () {
    ...
    test(
      'Detecta Remasters por palabras clave o HD cuando category es 0 o null',
      () {
        ...
        expect(
          IgdbConstants.resolveCategory(null, 'Zelda Twilight Princess HD'),
          9,
        );
      },
    );
    ...
    test('Detecta Ediciones Expandidas por palabras clave', () {
      ...
      expect(
        IgdbConstants.resolveCategory(0, 'The Witcher 3: Game of the Year'),
        10,
      );
      expect(
        IgdbConstants.resolveCategory(0, 'Cyberpunk 2077 Ultimate Edition'),
        10,
      );
    });
    ...
    test('Detecta Mods por palabra suelta en título o resumen', () {
      ...
      expect(
        IgdbConstants.resolveCategory(
          0,
          'Proyecto de fans',
          summary: 'Este es un mod creado por la comunidad',
        ),
        5,
      );
    });
    ...
    test(
      'Devuelve null para juegos base normales sin keywords ni parent_game',
      () {
  ...
  group('IgdbConstants Helpers & Formatters', () {
    ...
    test(
      'getCategoryColor respeta el color secundario del tema para Remakes (8)',
      () {
        const customSecondary = Colors.deepOrange;
        final color = IgdbConstants.getCategoryColor(
          8,
    ...
    test(
      'getPlatformStyle devuelve estilos específicos para plataformas conocidas',
      () {
        ...
        final unknownStyle = IgdbConstants.getPlatformStyle(
          'Plataforma Rara 3000',
        );
