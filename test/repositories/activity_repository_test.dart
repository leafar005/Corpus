...
void main() {
  ...
  group('ActivityRepository.mergeActivityItems', () {
    ...
    test('fusiona status_change sobre reviewed del mismo usuario+juego en <24h', () {
    ...
    test('fusiona reviewed sobre status_change del mismo usuario+juego en <24h', () {
      final statusChange = makeItem(
        actionType: 'status_change',
        createdAt: '2024-06-01T12:00:00',
      );
    ...
    test('NO fusiona eventos de distintos usuarios aunque sean el mismo juego', () {
      final sc1 = makeItem(
        actionType: 'status_change',
        userId: 'u1',
        createdAt: '2024-06-01T12:00:00',
    ...
    test('escenario completo: dos usuarios, múltiples juegos, merge selectivo', () {
      final items = [
