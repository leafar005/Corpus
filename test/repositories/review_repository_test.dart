...
void main() {
  group('ReviewRepository.sanitizeReviewData (Lógica de Limpieza en Wishlist)', () {
    test('Fuerza a null las notas de gameplay, narrativa, tiempo, etc. cuando status es "wishlist"', () {
    ...
    test('Conserva las notas, comentario e imágenes cuando status es "beaten" o "playing"', () {
      final sanitized = ReviewRepository.sanitizeReviewData(
        userId: 'user-123',
        igdbId: 100,
        status: 'beaten',
  ...
  group('ReviewRepository.computeUnlockedAchievements (Lógica de Logros Desbloqueados)', () {
    test('Detecta exactamente el ID del logro recién desbloqueado (1 antes -> 2 después)', () {
      final before = {'logro-bienvenida'};
      final after = {'logro-bienvenida', 'logro-primer-juego'};

      final unlocked = ReviewRepository.computeUnlockedAchievements(before, after);
    ...
    test('Maneja correctamente cuando el usuario parte de 0 logros antes de guardar', () {
      final before = <String>{};
      final after = {'logro-1'};
