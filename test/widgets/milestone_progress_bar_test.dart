...
void main() {
  group('MilestoneProgressBar Unit & Widget Tests', () {
    test('getSegmentColor devuelve colores correctos para Bronce, Plata y Oro', () {
    ...
    test('getSegmentColor salta Plata y usa Oro como segundo nivel cuando solo hay 2 hitos', () {
      const fallback = Colors.blue;
    ...
    testWidgets('Muestra textos de progreso con cantidad de juegos y XP', (WidgetTester tester) async {
    ...
    testWidgets('No renderiza nada (SizedBox.shrink) si la lista de hitos está vacía', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: MilestoneProgressBar(
