...
void main() {
  group('BundleService.storeRankPublic (Ranking y ordenación de tiendas)', () {
    test('Asigna rangos prioritarios a tiendas principales (Humble Bundle, Fanatical, Steam)', () {
    ...
    test('Ordena correctamente una lista de tiendas posicionando primero las principales', () {
      final stores = [
        'Itch.io',
        'Fanatical',
        'IndieGala',
      ...
      stores.sort((a, b) => BundleService.storeRankPublic(a).compareTo(BundleService.storeRankPublic(b)));
